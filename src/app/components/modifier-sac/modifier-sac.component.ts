  ...
  data=>{this.sac=data  
    console.log(this.sac)
     ...
     this.productForm=this.fb.group({
      ...
      categorie: [this.sac.categorie,Validators.required],//retourner categorie une liste de choix
      ...
      marque: [this.sac.marque,Validators.required],//retourner marque une liste de choix
